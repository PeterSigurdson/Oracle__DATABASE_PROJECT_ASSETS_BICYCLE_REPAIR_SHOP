select bc_bicycle_table.bike_id as BIKE_ID, bc_bicycle_table.price as PRICE, 
...
bc_repair_data.charge as "Repair Cost", bc_repair_data.cellphone as "Repair CustID"
